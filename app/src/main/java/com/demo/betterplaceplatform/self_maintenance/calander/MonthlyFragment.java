...
import com.demo.betterplaceplatform.self_maintenance.verticalviewpager.VerticalViewPager;
...
public class MonthlyFragment extends Fragment {
    ...
    public static com.demo.betterplaceplatform.self_maintenance.calander.MonthlyFragment newInstance(int year, int month) {

        HLog.d(TAG, NAME, "newInstance " + year + "/" + month);

        com.demo.betterplaceplatform.self_maintenance.calander.MonthlyFragment fragment =
                new com.demo.betterplaceplatform.self_maintenance.calander.MonthlyFragment();
